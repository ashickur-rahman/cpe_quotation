...
INSERT INTO `cpe_service` VALUES (1,'Cliping Path',1,'2021-12-13 17:25:26'),(2,'Multi-Ciping Path',2,'2021-12-14 01:50:20'),(3,'Image Musking',3,'2021-12-14 01:50:41'),(4,'Natural Shadow',4,'2021-12-14 02:14:32'),(5,'Reflaction Shadow',4,'2021-12-14 02:14:45'),(6,'Drop Shadow',4,'2021-12-14 02:15:59');
...
INSERT INTO `cpe_service_complexity` VALUES (1,1,'1-1','2021-12-13 17:25:42',NULL),(2,1,'1-2','2021-12-13 17:25:48',NULL),(3,1,'1-3','2021-12-13 17:25:53',NULL),(4,1,'1-4','2021-12-13 17:25:59',NULL),(5,2,'2-1','2021-12-19 08:47:57',NULL),(6,2,'2-2','2021-12-19 08:48:06',NULL),(7,5,'5-2','2021-12-19 08:49:56',NULL),(8,2,'2-3','2021-12-19 08:48:19',NULL),(9,2,'2-4','2021-12-19 08:48:26',NULL),(10,3,'3-1','2021-12-19 08:48:36',NULL),(11,3,'3-2','2021-12-19 08:48:45',NULL),(12,4,'4-1','2021-12-19 08:49:31',NULL),(13,5,'5-3','2021-12-19 08:50:05',NULL),(14,5,'5-1','2021-12-19 08:49:42',NULL),(15,4,'4-4','2021-12-19 08:54:34',NULL);
...
/*!50001 VIEW `cpe_service_all` AS select `cpe_service_complexity_price`.`id` AS `id`,`cpe_service_complexity_price`.`service_complexity_id` AS `service_complexity_id`,`cpe_service_complexity_price`.`price` AS `price`,`cpe_service_complexity_price`.`show_default` AS `show_default`,`cpe_service_complexity`.`name` AS `complexity_name`,`cpe_service_complexity`.`pictures` AS `complexity_pic`,`cpe_service`.`id` AS `service_id`,`cpe_service`.`name` AS `service_name`,`cpe_service`.`parent_service` AS `service_parent` from ((`cpe_service_complexity_price` join `cpe_service_complexity`) join `cpe_service`) where ((`cpe_service_complexity_price`.`service_complexity_id` = `cpe_service_complexity`.`id`) and (`cpe_service`.`id` = `cpe_service_complexity`.`service_id`)) */;
